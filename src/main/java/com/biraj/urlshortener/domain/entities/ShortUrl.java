package com.biraj.urlshortener.domain.entities;
...
public class ShortUrl {
    ...
    public com.biraj.urlshortener.domain.entities.User getCreatedBy() {
        return createdBy;
    }

    public void setCreatedBy(com.biraj.urlshortener.domain.entities.User createdBy) {
